...
$(document).ready(function(){
	...
	$(".chosenCharacters").click(function(){
		...
		$(".chosenCharacters").addClass("theChosenOne");
	...
	$(".attackButton").on("click", function(){
		if ($(".defenderSection").is(":empty")){
			...
			if ($(".enemiesCharacters").is(":empty") && $(".defenderSection").is(":empty") &&
				...
				$(".fightInfo").html("<p class='defeated textHover'>Click to play again.</p>")
				$(".defeated").on("click", function(){
					resetGame();
...
/////////////////////////////////////////////////////////////////////////////////
//// 																		 ////
////  This was found from codepen to add fireworks into the page upon win.   ////
////																		 ////
///////////////////////////////////////////////////////////////////////////////// 
/////////////////////////////////////////////////////////////////////////////////
